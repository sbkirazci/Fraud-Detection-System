...
# Tüm node'ları ve edge'leri ekle
...
# PyTorch Geometric'e çevir
data = from_networkx(G)
num_nodes = data.num_nodes

# Tüm node'lara özellik tensor'u ata
...
# AccountID node'larına özellikleri ekle
